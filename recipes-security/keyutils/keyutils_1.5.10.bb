# This file and the associated patch files were copied
# from recipes-security/keyutils/keyutils_1.5.10.bb as
# of commit ID bc8a459b07932343dc62a38cbd4669aa6ed02e2b in
# git://git.yoctoproject.org/meta-security (from the security-wip
# branch).
